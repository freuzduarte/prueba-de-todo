    ...
    agent any
        ...
        stage('Sonarcan') {
            steps {
                ...
                -Dsonar.login=squ_27920b448c22c6ca53d7dbae57a0b707c5113d7e'''
            }
        }
        stage('Build') {
            steps {
    ...
    post {
        always {
            script {
                ...
                slackSend(channel: '@U05690FEL7P', message: "Proyecto Creando Perfectamente *${currentBuild.currentResult}:* build ${env.BUILD_NUMBER}, ${env.JOB_NAME}", color: '#00FF04')
            }
        }
    }
}
